...
insert_query =  '''
                    ...
                    select distinct on (a.master_business_id,a.dealer_id, b.vin)
                        ...
                        b.miles
                    from 
                        aggregations.v_client_marketcheck_ca_new a,
                        vendors.marketcheck_ca_new b 
                    where 
...
while True:
    ...
    try:
        with postgres_etl_connection.cursor() as cursor:
            ...
            max_marketcheck_status_date = postgreshandler.get_max_value(postgres_etl_connection,'vendors','marketcheck_ca_new','status_date')
