...
while True:
    ...
    try:
        ...
        min_date_avr_button_widget_was_rendered = postgreshandler.get_min_value(postgres_etl_connection, 's3',
                                                                        'avr_button_widget_was_rendered', 'happened_at')
        ...
        max_date_avr_button_widget_was_rendered = postgreshandler.get_max_value(postgres_etl_connection, 's3',
                                                                        'avr_button_widget_was_rendered', 'happened_at')
        ...
        first_date = utility.add_months(max_date_avr_widget_impressions_ip_monthly,1) if max_date_avr_widget_impressions_ip_monthly is not None else utility.get_month(min(min_date_integrations_widget_was_rendered,min_date_avr_widget_impressions,min_date_integrations_button_widget_was_rendered,min_date_avr_button_widget_was_rendered))
        last_date = utility.get_month(min(max_date_integrations_widget_was_rendered,max_date_avr_widget_impressions,max_date_integrations_button_widget_was_rendered,max_date_avr_button_widget_was_rendered))
